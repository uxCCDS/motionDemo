(function () {
    ...
    var reset = function() {
        window.GOLBAL_POINT.M.state(0,false);
        window.GOLBAL_POINT.Dom_Button_Join_Bg.setAttribute('width','0');
        window.GOLBAL_POINT.Dom_Headphone.setAttribute('transform',"translate(0, -1200)");
        window.GOLBAL_POINT.Dom_Screen_Button1.setAttribute('width',"0");
        window.GOLBAL_POINT.Dom_Screen_Button2.setAttribute('width',"0");
        window.GOLBAL_POINT.Dom_Screen_Button3.setAttribute('width',"0");
        window.GOLBAL_POINT.M.play();
    };
